...
/**
 * Class Name: gs_primary_menu
 * Description: A custom WordPress nav walker class to implement UIkit menu markup
 */
class gs_primary_menu extends Walker_Nav_Menu {
...
/**
 * Class Name: gs_offcanvas_output
 * Description: A custom WordPress nav walker class to implement UIkit menu markup
 */
class gs_offcanvas_menu extends Walker_Nav_Menu {
