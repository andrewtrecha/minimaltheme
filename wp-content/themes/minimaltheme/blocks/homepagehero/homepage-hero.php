...
$quote             = !empty(get_field( 'quote' )) ? get_field( 'quote' ) : 'homepage hero...';
...
<div <?php echo esc_attr( $anchor ); ?>class="uk-container <?php echo esc_attr( $class_name ); ?>" style="<?php echo esc_attr( $style ); ?>">
